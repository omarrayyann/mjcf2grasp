...
def main(gripper_type="panda"):
    if gripper_type.lower() == "panda":
        gripper = PandaGripper(root_folder="")
    elif gripper_type.lower() == "rum":
        gripper = RUMGripper(root_folder="")
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        ...
        choices=["panda", "rum", "robotiq"],
        help="Type of gripper to visualize",
    )
    args = arg_parser.parse_args()
    gripper = main(gripper_type=args.gripper_type)
